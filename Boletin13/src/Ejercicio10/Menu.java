            ...
            switch (opt) {
                ...
                case 4:
                    map.forEach((codigoProducto,cantidad) -> System.out.println("Codigo de producto: " + codigoProducto + "\n \t Cantidad: " + cantidad)); /* Este metodo empieza al parecer por el más reciente, poniendolo primero esto tiene pinta de que es
                     mas util si quieres iterar una estructura como una lista o así y aplicar una funcion o así sobre los elementos que contiene el objeto o sobre el propio objeto o al menos esa es la impresion que me da aunque bueno, al no haber un criterio de como se tiene que mostrar pues me da igual
